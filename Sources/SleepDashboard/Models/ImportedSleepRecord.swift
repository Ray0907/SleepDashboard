...
@Model
final class ImportedSleepRecord {
	var sourceFile: String
	@Attribute(.unique) var sourceRowFingerprint: String
	var startDate: Date
	var endDate: Date
	...
	convenience init(parsedRecord: ParsedSleepRecord) {
		self.init(
			sourceFile: parsedRecord.sourceFile,
			sourceRowFingerprint: parsedRecord.sourceRowFingerprint,
			startDate: parsedRecord.startDate,
			endDate: parsedRecord.endDate,
